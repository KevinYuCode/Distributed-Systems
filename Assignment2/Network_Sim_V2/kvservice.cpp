...
void KVServiceServer::setPort(in_port_t port)
{
    PORT = port;
}

// SETTING THE SERVICE NAME
void KVServiceServer::setSvcName(string svcName)
{
    this->svcName = svcName;
}

// Method gets called in startServices() in the server class
...
bool KVServiceServer::registerService(ServerRegisterInfo serverInfo)
{
